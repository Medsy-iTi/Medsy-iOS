...
enum AppColor {
    ...
    static var textPrim: Color { AppSettings.shared.isDarkMode ? Color(hex: "#EEF7F2") : Color(hex: "#1A1A1A") }
    static var textSec: Color { AppSettings.shared.isDarkMode ? Color(hex: "#9AB5A8") : Color(white: 0, opacity: 0.52) }
