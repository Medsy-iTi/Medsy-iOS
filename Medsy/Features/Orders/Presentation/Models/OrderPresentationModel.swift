...
extension OrderDetailPresentationModel {
    static let mock = OrderDetailPresentationModel(
        ...
        date: Calendar.current.date(byAdding: .hour, value: -2, to: .now)!,
        items: [
            OrderDetailItemModel(id: 1, productName: "Panadol 500mg", quantity: 2, unitPrice: 45),
            OrderDetailItemModel(id: 2, productName: "Vitamin C 1000mg", quantity: 1, unitPrice: 90),
        ],
        deliveryFee: 25,
        totalPrice: 180
    )
