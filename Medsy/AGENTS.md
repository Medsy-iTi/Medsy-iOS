...
- Declare every reusable SwiftUI component as an independent `struct` conforming to `View` in its own file. Do not create component views using computed `var` properties
