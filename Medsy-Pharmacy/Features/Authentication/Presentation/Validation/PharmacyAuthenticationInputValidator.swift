//
//  PharmacyAuthenticationInputValidator.swift
//  Medsy-Pharmacy
//
...
enum PharmacyAuthenticationValidationError: Equatable {
    ...
    var message: String {
        switch self {
        case .firstNameRequired:
            "pharmacy.auth.validation.first_name_required".localized
        case .lastNameRequired:
            "pharmacy.auth.validation.last_name_required".localized
        case .phoneRequired:
            "pharmacy.auth.validation.phone_required".localized
        case .emailRequired:
            "pharmacy.auth.validation.email_required".localized
        case .passwordRequired:
            "pharmacy.auth.validation.password_required".localized
        case .confirmedPasswordRequired:
            "pharmacy.auth.validation.confirm_password_required".localized
        case .homeAddressRequired:
            "pharmacy.auth.validation.home_address_required".localized
        case .invalidFirstName:
            "pharmacy.auth.validation.first_name".localized
        case .invalidLastName:
            "pharmacy.auth.validation.last_name".localized
        case .nameTooLong:
            "pharmacy.auth.validation.name_length".localized
        case .invalidPhone:
            "pharmacy.auth.validation.phone".localized
        case .invalidEmail:
            "pharmacy.auth.validation.email".localized
        case .passwordLength:
            "pharmacy.auth.validation.password_length".localized
        case .passwordWhitespace:
            "pharmacy.auth.validation.password_whitespace".localized
        case .weakPassword:
            "pharmacy.auth.validation.password_strength".localized
        case .passwordMismatch:
            "pharmacy.auth.validation.password_mismatch".localized
        case .futureDateOfBirth:
            "pharmacy.auth.validation.date_of_birth".localized
        }
    }
}

enum PharmacyAuthenticationInputValidator {
    ...
    static func validateLogin(email: String, password: String) -> PharmacyAuthenticationValidationError? {
        if normalizedEmail(email).isEmpty { return .emailRequired }
        if password.isEmpty { return .passwordRequired }
        if !isValidEmail(email) { return .invalidEmail }
        return nil
